...
#' \describe{
#'   \item{party_short}{The short name (acronym) of the party}
#'   \item{party_long}{The long (spelled-out) name of the party}
#'   }
#'
#'@source This dataset is based on data published by the Bundeswahlleiter 2017, (c) Der Bundeswahlleiter, Wiesbaden 2017, https://www.bundeswahlleiter.de/info/impressum.html
#'
